...
const Navbar = ({
  ...
  const aboutClickOutside = useRef(null);

  useEffect(() => {
    const button = document.querySelector("#aboutSmall");

    const handleClick = (event) => {
      if (window.location.pathname === "/") {
        console.log("It's the main page");
      } else {
        console.log("Its not on main page");
              ...
              <div className="ml-[1.371rem] mt-[1.263rem] mb-[1.263rem] mr-[1.371rem] text-white flex justify-between relative z-[99] myScreen4:w-[16.5rem]">
                ...
                >
                  <div className=" flex  flex-col  justify-center  items-center bg-[#172a45]  mt-[3.5rem] w-[56vw] ml-6 overflow-hidden">
                    ...
                    <button className="py-[18px] px-[50px] flex  justify-center  items-center  mt-[4rem]  bg-[#172a45] border  border-[#64ffda]  rounded  font-mono  text-[#64ffda]  tracking-wide cursor-pointer antialiased">
                      Resume
                    </button>
                  </div>
                </div>
      ...
      {showSecondDiv && (
        <div className="block md:hidden">
          ...
          >
            ...
            <div
              onClick={handleLogoClick}
              className=" w-11  h-12  flex  justify-center items-center ml-"
            >
              <svg
                id="logo"
                className={isActive ? "styledLogo" : "unstyledLogo"}
          ...
          >
            <div className="ml-[1.371rem] mt-[1.263rem]  mb-[1.263rem] mr-[1.371rem] text-white flex justify-between z-50 ">
              ...
              <div className="flex justify-between items-center antialiased">
                ...
                <span className="text-[13px] p-[10px] no-underline transition-whereIWorkedTransitionProperty duration-whereIWorkedTransitionDuration ease-whereIWorkedTransitionTiming cursor-pointer mr-[10px] font-customMono myScreen5:px-[5px]">
                ...
                <button
                  onClick={() => setResumeBtnClicked(true)}
