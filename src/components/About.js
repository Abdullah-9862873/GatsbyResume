        ...
        <div className="h-auto py-12">
          <div className="relative">
            <img
              ...
              src={
                clickedSm
                  ? "https://res.cloudinary.com/dyoczrvps/image/upload/v1675279126/newProfilePortfolio/610AC1B3-3EAE-438F-9E7E-159A1ACAFB28_hev1wt.png"
                  : "https://res.cloudinary.com/dyoczrvps/image/upload/v1675278667/newProfilePortfolio/clr_1_y6cakh.png"
              }
              alt="profile"
          ...
          <div className="h-auto py-12">
            <div className="relative">
              <img
                ...
                src={
                  clicked
                    ? "https://res.cloudinary.com/dyoczrvps/image/upload/v1674429185/Portfolio/Web_xwzr2a.jpg"
                    : "https://res.cloudinary.com/dyoczrvps/image/upload/v1674584196/Portfolio/clr_1_aavn7k.jpg"
                }
                alt="profile"
                className="h-auto w-auto mr-auto ml-auto object-cover transition-ImageTransitionProperty duration-ImageTransitionDuration ease-ImageTransitionTiming delay-ImageTransitionDelay z-10 opacity-100 relative"
                style={{
