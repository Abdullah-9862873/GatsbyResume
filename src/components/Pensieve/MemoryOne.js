...
const MemoryOne = () => {
  ...
  return (
    <div className="ml-12 mr-12 myScreen6:ml-[6.338rem] myScreen6:mr-[6.338rem] myScreen7:ml-[9.07rem] myScreen7:mr-[9.07rem] antialiased">
      {/* Back to All Memories */}
      <div
        className={`contentContainer ${
          showFirstContent ? "show" : ""
        } w-[70%] mr-auto ml-auto text-[#64ffda] pt-[70px] text-[14px] font-customMono`}
      >
      ...
      {/* Blog */}
      <div className="w-[70%] mr-auto ml-auto mt-[40px]">
        <img
        ...
        <div>
          ...
          <div className="mr-auto ml-auto mt-[40px]">
            <img
              ...
              className={`contentContainer ${
                firstListingImageVisible ? "show" : ""
              }`}
              src="https://res.cloudinary.com/dyoczrvps/image/upload/v1676344712/newProfilePortfolio/Pensieve/Content_Writer_final2_zkf1xe.jpg"
              alt="PensieveCover"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mr-auto ml-auto mt-[40px]">
            <img
              ...
              src="https://res.cloudinary.com/dyoczrvps/image/upload/v1676369067/newProfilePortfolio/Pensieve/annie-spratt-hCb3lIB8L8E-unsplash_v9lp3p.jpg"
              alt="PensieveCover"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mr-auto ml-auto mt-[40px]">
            <img
              ...
              src="https://res.cloudinary.com/dyoczrvps/image/upload/v1676370407/newProfilePortfolio/Pensieve/austin-distel-rxpThOwuVgE-unsplash_cx4qpr.jpg"
              alt="PensieveCover"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mr-auto ml-auto mt-[40px]">
            <img
              ...
              src="https://res.cloudinary.com/dyoczrvps/image/upload/v1676371703/newProfilePortfolio/Pensieve/chris-montgomery-smgTvepind4-unsplash_mhumru.jpg"
              alt="PensieveCover"
            />
          </div>
        </div>
        ...
        <div>
          ...
          >
            <img
              src="https://res.cloudinary.com/dyoczrvps/image/upload/v1676372415/newProfilePortfolio/Pensieve/siora-photography-hgFY1mZY-Y0-unsplash_kurf6x.jpg"
              alt="PensieveCover"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mr-auto ml-auto mt-[40px]">
            <img
              ...
              src="https://res.cloudinary.com/dyoczrvps/image/upload/v1676381471/newProfilePortfolio/Pensieve/clement-helardot-95YRwf6CNw8-unsplash_baczwv.jpg"
              alt="PensieveCover"
            />
          </div>
        </div>
        ...
        <div>
          ...
          >
            <img
              src="https://res.cloudinary.com/dyoczrvps/image/upload/v1676384340/newProfilePortfolio/Pensieve/FinalCertificate_r0mwmy.jpg"
              alt="PensieveCover"
            />
          </div>
        </div>
        ...
        <div>
          ...
          >
            <img
              src="https://res.cloudinary.com/dyoczrvps/image/upload/v1676987816/newProfilePortfolio/Pensieve/Abdullah_ryj5ur.jpg"
              alt="PensieveCover"
            />
          </div>
        </div>
