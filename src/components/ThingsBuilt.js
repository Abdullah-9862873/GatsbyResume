    ...
    >
      ...
      <div className={" block md:hidden"}>
        ...
        >
          ...
          <div className="grid grid-template-rows-4 grid-template-columns-2 gap-[10px] place-items-start text-[13px] text-[#64ffda] font-customMono bg-transparent antialiased row-start-1 col-start-1 pt-[40px] px-[40px] pb-[30px] tbScreen1:mt-[3%] tbScreen2:mt-[1%] tbScreen2:pt-[25px] tbScreen2:gap-[3px] tbScreen5:mt-[-2%] tbScreen5:px-[20px]">
            ...
            <div className="flex w-[60px] justify-between tbScreen8:w-[50px]">
              <a
                target="_blank"
      ...
      <div className={" hidden md:block"}>
        ...
        >
          ...
          >
            <a href="https://res.cloudinary.com/dyoczrvps/image/upload/v1674913011/Portfolio/Java_SM_xwpbl9.jpg">
              <div>
                <img
        ...
        >
          <div class="project-content2 text-left text-[13px] text-[#64ffda] font-customMono bg-transparent antialiased ">
            ...
            <div className="flex w-[60px] justify-between tbScreen8:w-[50px]">
              <a
                ...
                target="_blank"
                className="tbScreen1:mt-[30px] tbScreen3:mt-[15px] tbScreen4:mt-[20px] tbScreen5:mt-[10px] inline-block text-[#ccd6f6] w-[20px] h-[20px] cursor-pointer antialiased transition-whereIWorkedTransitionProperty ease-whereIWorkedTransitionTiming duration-whereIWorkedTransitionDuration"
                href="https://github.com/Abdullah-9862873/Full_Stack_Ecommerce_Store"
                aria-label="GitHub Link"
              >
                <svg
              ...
              <span className="h-[22px] w-[22px] text-[#ccd6f6] tbScreen1:mt-[30px] tbScreen3:mt-[15px] tbScreen4:mt-[20px] tbScreen5:mt-[10px] transition-whereIWorkedTransitionProperty ease-whereIWorkedTransitionTiming duration-whereIWorkedTransitionDuration">
                <a
          ...
          >
            <a href="https://res.cloudinary.com/dyoczrvps/image/upload/v1675708083/Portfolio/Dashboard_1_Green_f6qe45.jpg">
              <div>
                <img
